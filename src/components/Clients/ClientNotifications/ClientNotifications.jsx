...
const ClientNotifications = ({notifications}) => {
    const {
      ...
      return (
        <Layout layoutSetings={notifications}>
            ...
            <div className={dashboardConGrid}>
              <div>
                ...
                {notifications === true?'':<div className={subgridCon}>
                  <div>
                    <article>
                      <h4>Ongoing Jobs</h4>
                      <p>1</p>
                ...
                {notifications === true?'':<div className={projectStatus}>
              ...
              <div className={secondGrid}>
                <article>
                  {notifications===true?'':<MdOutlineMilitaryTech size={40} />}
                  { notifications===true?'':<MdOutlineNotifications size={40} />}
                  <button>
                    <img src={profile} alt="profile" />
                  </button>
                </article>
                {notifications=== true?'':<div>
            ...
            {notifications === true?"":<div className={tableCon}>
              <article>
                <h4>Invoice</h4>
                <article>
                <p>1 - 50</p>
            ...
            {notifications === true?<div className={notificationsDisplay}>
              <img src={all_inbox} alt="notifications" />
